...
public class SwitchImageEntity extends Image {
    protected TextureRegionDrawable[] texture50, texture75, texture100, texture150, texture200,
            texture300, texture400;
    protected String assetPath;
    protected String assetNameOn;
    protected String assetNameOff;
    protected AssetManager assetManager;
    protected int status;
    private int size;

    public SwitchImageEntity() {
        status = 1;
        size = 100;
    }
    ...
    public void prepareAssets() {
        setAssetAddress();
        texture50 = new TextureRegionDrawable[2];
        texture75 = new TextureRegionDrawable[2];
        texture100 = new TextureRegionDrawable[2];
        texture150 = new TextureRegionDrawable[2];
        texture200 = new TextureRegionDrawable[2];
        texture300 = new TextureRegionDrawable[2];
        texture400 = new TextureRegionDrawable[2];

        TextureAtlas atlas = assetManager.get(assetPath + "/0.5x/pack.atlas",
                TextureAtlas.class);
        texture50[0] = new TextureRegionDrawable(atlas.findRegion(assetNameOn));
        texture50[1] = new TextureRegionDrawable(atlas.findRegion(assetNameOff));
        atlas = assetManager.get(assetPath + "/0.75x/pack.atlas", TextureAtlas.class);
        texture75[0] = new TextureRegionDrawable(atlas.findRegion(assetNameOn));
        texture75[1] = new TextureRegionDrawable(atlas.findRegion(assetNameOff));
        atlas = assetManager.get(assetPath + "/1x/pack.atlas", TextureAtlas.class);
        texture100[0] = new TextureRegionDrawable(atlas.findRegion(assetNameOn));
        texture100[1] = new TextureRegionDrawable(atlas.findRegion(assetNameOff));
        atlas = assetManager.get(assetPath + "/1.5x/pack.atlas", TextureAtlas.class);
        texture150[0] = new TextureRegionDrawable(atlas.findRegion(assetNameOn));
        texture150[1] = new TextureRegionDrawable(atlas.findRegion(assetNameOff));
        atlas = assetManager.get(assetPath + "/2x/pack.atlas", TextureAtlas.class);
        texture200[0] = new TextureRegionDrawable(atlas.findRegion(assetNameOn));
        texture200[1] = new TextureRegionDrawable(atlas.findRegion(assetNameOff));
        atlas = assetManager.get(assetPath + "/3x/pack.atlas", TextureAtlas.class);
        texture300[0] = new TextureRegionDrawable(atlas.findRegion(assetNameOn));
        texture300[1] = new TextureRegionDrawable(atlas.findRegion(assetNameOff));
